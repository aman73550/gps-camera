...
INSERT INTO app_settings (id, delete_after_months, auto_delete_enabled, required_version, force_update)
...
ALTER TABLE app_settings ADD COLUMN IF NOT EXISTS force_update BOOLEAN NOT NULL DEFAULT FALSE;
